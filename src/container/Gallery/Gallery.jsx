...
const Gallery = () => (
  <div className='w-[100%] h-[110%] md:h-[500px ]  gallery__main'>
   <div className='flex flex-col items-center justify-center md:flex-row md:justify-around md:items-center  h-[100%]'>
     <div className='flex flex-col justify-evenly items-center md:items-start ml-10'>
     ...
     <div className='grid grid-cols-2 gap-10 md:flex md:flex-row md:items-center md:justify-around'>
      <div className='mr-5 relative gallery__image'>
